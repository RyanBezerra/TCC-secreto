...
class ProfileWidget(QWidget):
    ...
    def _create_header(self, parent_layout):
        """Cria o cabeçalho compacto e profissional"""
        header_frame = QFrame()
        ...
        if not logo_pixmap.isNull():
            ...
            logo_icon.setPixmap(qta.icon('fa5s.user-circle', color="#000000").pixmap(24, 24))
        logo_container.addWidget(logo_icon)
        
        # Título compacto
        title_label = QLabel("Perfil do Usuário")
        title_label.setFont(get_portable_font("Segoe UI", 16, QFont.Weight.Bold))
        ...
        back_button.setFont(get_portable_font("Segoe UI", 11, QFont.Weight.Medium))
    ...
    def _create_personal_info_section(self):
        ...
        title_icon = QLabel()
        title_icon.setPixmap(qta.icon('fa5s.user', color="#000000").pixmap(18, 18))
        ...
        # Botão de editar compacto
        self.edit_button = QPushButton("Editar")
        self.edit_button.setIcon(qta.icon('fa5s.edit', color="#666666"))
        self.edit_button.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
    ...
    def _create_info_fields(self, parent_layout):
        ...
        age_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        age_label.setStyleSheet("color: #000000;")
        ...
        grade_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        grade_label.setStyleSheet("color: #000000;")
        fields_layout.addWidget(grade_label, 2, 0)
        
        self.grade_input = QLineEdit()
        self.grade_input.setFont(QFont("Segoe UI", 10))
        self.grade_input.setMinimumHeight(28)
        ...
        date_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        ...
        self.date_input.setMinimumHeight(28)
        ...
        last_access_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        last_access_label.setStyleSheet("color: #000000;")
        ...
        self.last_access_input.setMinimumHeight(28)
    ...
    def _create_stats_section(self):
        ...
        stats_icon = QLabel()
        stats_icon.setPixmap(qta.icon('fa5s.chart-bar', color="#000000").pixmap(18, 18))
        ...
        stats_title.setStyleSheet("color: #000000;")
    ...
    def _create_stats_items(self, parent_layout):
        ...
        lessons_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        lessons_label.setStyleSheet("color: #000000;")
        stats_layout.addWidget(lessons_label, 0, 0)
        
        self.lessons_count = QLabel("0")
        self.lessons_count.setFont(QFont("Segoe UI", 14, QFont.Weight.Bold))
        self.lessons_count.setStyleSheet("color: #000000;")
        stats_layout.addWidget(self.lessons_count, 0, 1)
        
        # Tempo de estudo
        time_label = QLabel("Tempo de Estudo")
        time_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        time_label.setStyleSheet("color: #000000;")
        stats_layout.addWidget(time_label, 1, 0)
        
        self.study_time = QLabel("0 horas")
        self.study_time.setFont(QFont("Segoe UI", 14, QFont.Weight.Bold))
        self.study_time.setStyleSheet("color: #000000;")
        stats_layout.addWidget(self.study_time, 1, 1)
        
        # Conquistas
        achievements_label = QLabel("Conquistas")
        achievements_label.setFont(QFont("Segoe UI", 10, QFont.Weight.Medium))
        achievements_label.setStyleSheet("color: #000000;")
        stats_layout.addWidget(achievements_label, 2, 0)
        
        self.achievements_count = QLabel("0")
        self.achievements_count.setFont(QFont("Segoe UI", 14, QFont.Weight.Bold))
        self.achievements_count.setStyleSheet("color: #000000;")
    ...
    def _create_feedback_tab(self):
        ...
        feedback_card_layout.setSpacing(10)
