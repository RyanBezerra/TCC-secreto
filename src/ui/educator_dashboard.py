...
from PySide6.QtWidgets import (
    ...
    QStatusBar, QToolBar, QSpacerItem, QStackedWidget, QAbstractItemView, QDialog
)
...
class EducatorDashboard(QMainWindow):
    ...
    def _create_students_page(self):
        ...
        self.students_table.setHorizontalHeaderLabels(["Nome", "Idade", "Nota", "Último Acesso", "Pesquisas", "Ações"])
