...
Sistema de conexão e operações com PostgreSQL e SQLite
"""
...
# Função para obter o gerenciador de banco correto
def get_database_manager():
    """Retorna o gerenciador de banco apropriado baseado na configuração"""
    if config.database.use_sqlite and SQLITE_AVAILABLE:
        logger.info("Usando SQLite como banco de dados local")
